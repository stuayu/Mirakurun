...
const tunerStderr_1 = require("./tunerStderr");
...
class TunerDevice extends eventemitter3_1.EventEmitter {
    ...
    _spawn(ch) {
        ...
        this._process.once("close", (code, signal) => {
            ...
            if (isBonRecTest && (bonRecTestStartupFailed || (0, tunerStderr_1.isBonRecTestStartupError)(stderrBuffer))) {
                this._closing = true;
            }
        ...
        this._process.stderr.on("data", data => {
            const parsed = (0, tunerStderr_1.consumeTunerStderr)(stderrBuffer, data);
            stderrBuffer = parsed.remainder;
            for (const message of parsed.messages) {
                if (isBonRecTest && (0, tunerStderr_1.isBonRecTestStartupError)(message)) {
